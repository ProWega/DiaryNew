...
const siteData = deserializeFunctions(JSON.parse('{"lang":"ru-RU","dir":"ltr","title":"NewDiary Docs","description":"Продуктовая, эксплуатационная и QA-документация проекта NewDiary.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Обзор","link":"/"},{"text":"Деплой","link":"/deploy/ubuntu-docker"},{"text":"QA","link":"/qa/playbook"},{"text":"Архитектура","link":"/architecture/overview"},{"text":"Reference","link":"/reference/environment"}],"search":{"provider":"local"},"outline":{"level":[2,3],"label":"На странице"},"sidebar":[{"text":"Старт","items":[{"text":"Обзор","link":"/"},{"text":"Локальный запуск","link":"/getting-started/local-setup"},{"text":"Первый администратор и auth","link":"/getting-started/first-admin-and-auth"}]},{"text":"Продукт","items":[{"text":"Роли и ключевые сценарии","link":"/product/roles-and-flows"}]},{"text":"Деплой","items":[{"text":"Ubuntu + Docker","link":"/deploy/ubuntu-docker"},{"text":"Release checklist","link":"/deploy/release-checklist"}]},{"text":"QA","items":[{"text":"QA Playbook","link":"/qa/playbook"},{"text":"Smoke checklist","link":"/qa/smoke-checklist"},{"text":"Bug report template","link":"/qa/bug-report-template"},{"text":"UAT sign-off","link":"/qa/uat-signoff"}]},{"text":"Ops","items":[{"text":"Magic links и доступы","link":"/ops/magic-links-and-access"},{"text":"Сервисные команды","link":"/ops/service-commands"}]},{"text":"Архитектура","items":[{"text":"Обзор архитектуры","link":"/architecture/overview"},{"text":"Контур документации","link":"/architecture/documentation-workflow"}]},{"text":"Reference","items":[{"text":"Переменные окружения","link":"/reference/environment"},{"text":"NPM scripts","link":"/reference/scripts"},{"text":"Маршруты и API","link":"/reference/routes-and-api"}]}]},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.DSrn02ED.js"));
