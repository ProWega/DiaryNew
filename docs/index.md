...
- [Curator AI v2](/architecture/curator-ai) — narrative-brief куратора, чат «Разговор с ИИ», концепции мероприятий, бюджет токенов.
- [Methodology mapping](/architecture/methodology-mapping) — связь методологии «Дневник пути» и схемы БД.
