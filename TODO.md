...
- настройка текстовых вопросов рефлексии с обязательностью для мероприятий и итогов дня;
...
- оценка состояния по событиям, ответы на настроенные вопросы/комментарий и дневная рефлексия;
