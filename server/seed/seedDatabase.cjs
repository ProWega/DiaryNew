...
const STATES = [
  ["apathy", 0, "Апатия", "Апатия", "😴", "#86c8ff", "#e2f3ff", "#2b688f"],
  ["passive", 1, "Пассивность", "Пассивность", "😶", "#8dd8e8", "#e0f9fb", "#2b6d78"],
  ["relaxed", 2, "Расслабленность", "Расслабленность", "🙂", "#b9e8c7", "#edfbf1", "#35684a"],
  ["balance", 3, "Баланс", "Баланс", "😊", "#b8e26f", "#f1fad8", "#52652a"],
  ["engaged", 4, "Вовлечённость", "Вовлечённость", "😀", "#ffd568", "#fff5d7", "#8a6321"],
  ["overstimulated", 5, "Перевозбуждённость", "Перевозбуждённость", "😵", "#ffb46b", "#fff0df", "#93511a"],
  ["panic", 6, "Паника", "Паника", "😰", "#ff8a7b", "#ffe6e2", "#963e3a"],
];
  ...
  for (const session of SESSIONS) {
    await upsert("sessions", {
      ...
      settings: JSON.stringify({
        scaleNote: "Шкала активации: от апатии до паники",
