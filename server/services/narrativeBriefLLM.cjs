...
/**
 * Glossary of working terms — активационная шкала «от Апатии до Паники» +
 * journey-stage словарь. См. docs/architecture/methodology-mapping.md §1.
 */
const ALLOWED_TERMS = [
  "путь",
  "тетрадь",
  ...
  "спутник",
  "дорога",
  // 7-балльная активационная шкала
  "апатия",
  "пассивность",
  "расслабленность",
  "баланс",
...
Что нельзя нарушать:
1. Никаких диагностических ярлыков. Не используй слова: ${BANNED_TERMS.join(", ")}. Без оценок «хорошо/плохо».
2. Опирайся на словарь программы (активационная шкала + journey-stage): ${ALLOWED_TERMS.join(", ")}.
