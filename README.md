...
- organizer workspace с заездами, регистрацией, программой, днями, событиями, группами и аналитическими блоками;
- mobile-first participant diary с выбором дня, оценкой состояния, комментарием и дневной рефлексией;
