...
- Кабинет участника:
  ...
  - prop-driven компонент `StateScalePicker` для шкалы состояния: 7 состояний, 3 зоны, варианты `arc`, `zones`, `compact`;
...
- `Participant/StateScalePicker` - проверка шкалы состояния через Controls: вариант отображения, анимация, выбранное состояние, disabled и описания.
