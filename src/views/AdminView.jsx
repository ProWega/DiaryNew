    ...
    <section className="role-view">
      <div className="hero-card">
        ...
        <div className="hero-stats">
          <MetricBadge label="Ролей" value={`${adminOverview.accessMatrix.length}`} />
          <MetricBadge label="Security cards" value={`${adminOverview.securityCards.length}`} />
          <MetricBadge label="Audit events" value={`${adminOverview.auditLog.length}`} />
        </div>
      </div>
      ...
      <div className="organizer-grid">
        <article className="panel-card wide-card">
          ...
          <div className="table-wrap">
            <table className="data-table">
              ...
              <tbody>
                {adminOverview.accessMatrix.map((row) => (
                  <tr key={row.role}>
                    <td>{row.role}</td>
                    <td>{row.rights}</td>
                  </tr>
        ...
        <article className="panel-card">
          ...
          <div className="theme-wrap">
            {adminOverview.securityCards.map((card) => (
