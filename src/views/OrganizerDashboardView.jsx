...
function OrganizerDashboardView({ dashboard }) {
  return (
    <section className="role-view">
      <div className="hero-card">
        ...
        <div className="hero-stats">
          <MetricBadge label="Заполнение заезда" value={`${dashboard.overallCompletion}%`} />
          <MetricBadge label="Групп" value={`${dashboard.groups.length}`} />
          <MetricBadge label="Типологий" value={`${dashboard.typologies.length}`} />
          <MetricBadge label="ИИ-отчётов" value={`${dashboard.aiReports.length}`} />
        </div>
      </div>
      ...
      <div className="organizer-grid">
        ...
        <article className="panel-card">
          ...
          <div className="report-stack">
            {dashboard.aiReports.map((report) => (
        ...
        <article className="panel-card">
          ...
          <div className="table-wrap">
            <table className="data-table is-compact">
              ...
              <tbody>
                {dashboard.importPreview.map((row) => (
